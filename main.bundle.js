...
var AppComponent = /** @class */ (function () {
    ...
    AppComponent.prototype.onStartButtonClicked = function () {
        ...
        this.httpQuestionService.getQuestion().subscribe(function (question) { return _this.evaluator.nextQuestion(question); });
    };
...
var EvaluatorService = /** @class */ (function () {
    ...
    EvaluatorService.prototype.nextQuestion = function (question) {
    ...
    EvaluatorService.prototype.getMaxQuestions = function (nextQuestion) {
        if (nextQuestion === void 0) { nextQuestion = this.selectedQuestion; }
        var tmp = nextQuestion;
        var numberOfQuestions = this.answered.size + 1;
        while (tmp != null) {
...
var QuestionnaireComponent = /** @class */ (function () {
    function QuestionnaireComponent(evaluator) {
        this.evaluator = evaluator;
        this.maxQuestions = 0;
        this.currentAnsweredQuestions = 0;
    }
